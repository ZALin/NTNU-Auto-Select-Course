...
Sucess_login = False
userid = raw_input('Please input student ID: ')
password = getpass.getpass('Please input Password: ')

while Sucess_login == False :
	...
	if 'success:true' in response.content :
		Sucess_login = True
		print "Success Login"
	elif '驗證碼錯誤' in response.content :
		print "驗證碼錯誤... auto try again..."
	else :
		print 'Error with ' + response.content[19:-1]
		userid = raw_input('Please input student ID: ')
		password = getpass.getpass('Please input Password: ')
print "Sucess_login"